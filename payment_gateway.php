<?php
session_start(); // This should be at the very top

include 'connect.php'; // Ensure connect.php does not call session_start()
            ...
            <?php if (!empty($_SESSION['cart'])): ?>
                <ul>
                    ...
                    <?php foreach ($_SESSION['cart'] as $course_id): ?>
                        <?php
                        $course_query = $conn->query("SELECT title, price FROM courses1 WHERE id = $course_id");
